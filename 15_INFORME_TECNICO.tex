...
\begin{itemize}
    \item \textbf{Protocolo SISER}: Implementa el handshake de registro (offlineEnquiry + sendAddress) y el comando readMichele para leer datos del inversor monof\'asico H.P.6065REL-D con 3 entradas MPPT DC. El frame del protocolo fue dise\~nado para SENTR 3/3 trif\'asico; el H.P.6065REL-D reutiliza el mismo layout pero replica el mismo valor de monof\'asico en los offsets L1/L2/L3.
    ...
    \item \textbf{Lectura peri\'odica}: Cada 5 segundos, lee temperatura, voltaje/corriente/potencia por MPPT, voltaje/corriente de red monof\'asica, frecuencia, estado, energ\'ia acumulada y horas totales
    ...
    \item \textbf{3 MPPTs + AC monof\'asico}: Lee datos de los 3 MPPTs DC del inversor (voltaje, corriente y potencia por cada MPPT, s\'olo MPPT2 con paneles). La salida AC es monof\'asica 220V; los offsets L1/L2/L3 del protocolo son redundantes del mismo valor.
\end{itemize}
